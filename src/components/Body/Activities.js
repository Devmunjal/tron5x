          ...
          <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
              <div class="section-heading">
                <h5 class="subtitle">The Smarter Way</h5>
                <h2 class="title">Lend and Borrow</h2>
                <p class="text">
                  The World's First Crypto Lending Marketplace and Affordable and
                ...
                <ul class="nav nav-lend mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item">
                    <a
                      ...
                      data-toggle="pill"
                      href="index.html#pills-all-bets"
                      role="tab"
                  ...
                  <li class="nav-item">
                    <a
                      ...
                      data-toggle="pill"
                      href="index.html#pills-my-jackpots"
                      role="tab"
