...
function MainFooter(){
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="heading-area">
                          <h5 class="sub-title">subscribe to Dooplo</h5>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="footer-widget info-link-widget">
                ...
                <ul class="link-list">
                  ...
                  <li>
                    <a href="index.html#">
                      <i class="fas fa-angle-double-right"></i> Authenticity
                      Guarantee
                    </a>
                  </li>
                  <li>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="footer-widget info-link-widget">
                ...
                <ul class="link-list">
                  ...
                  <li>
                    <a href="index.html#">
                      <i class="fas fa-angle-double-right"></i> Account
                      Varification
                    </a>
                  </li>
                  <li>
        ...
        <div class="modal-body">
          ...
          <div class="form-footer">
            <p>
              Not a member?
              <a href="index.html#"
                >Create account <i class="fas fa-angle-double-right"></i
              ></a>
            </p>
          </div>
        </div>
  ...
  <div
    class="modal fade login-modal sign-in"
    id="signin"
    tabindex="-1"
    role="dialog"
              ...
              <div class="form-group">
                <div class="check-group">
                  ...
                  <label for="input-terms">
                    I agree with
                    <a href="index.html#">terms and Conditions</a> and
                    <a href="index.html#">privacy policy</a>
                  </label>
                </div>
              </div>
